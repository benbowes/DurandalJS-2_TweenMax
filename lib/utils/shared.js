define(['jquery', 'TimelineMax', 'knockout'], function ($, TimelineMax, ko) {

    var shared = {
        
        defaultTimelineAnimation: function($view, revCompleteFunc, revCompleteScope){
        	
        	var tl = new TimelineMax({onReverseComplete:revCompleteFunc, onReverseCompleteParams:[revCompleteScope]});
